...
alternatives --install /usr/bin/java java $JAVA_HOME/bin/java 0
alternatives --install /usr/bin/jar jar $JAVA_HOME/bin/jar 0
alternatives --install /usr/bin/javac javac $JAVA_HOME/bin/javac 0
